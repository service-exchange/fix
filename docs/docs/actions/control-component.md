...
![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/inspector.png)
...
![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/updated.png)
...
![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/button.png)
...
![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/set.png)
...
![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/jsoption.png)

</div>

<div style={{textAlign: 'center'}}>

![Tele-CMS - Action reference - Control Component](/img/actions/controlcomponent/clear.png)
