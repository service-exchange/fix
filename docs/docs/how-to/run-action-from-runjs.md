...
Now you can trigger all the `actions` available in Tele-CMS from within the `RunJS` query. This guide includes the syntax for each action along with the example.
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/runquery.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/setvariable.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/unsetvariable.png)
...
**Example:** Triggering `actions.logout()` will log out the current logged in user from the Tele-CMS and will redirect to sign in page.

<div style={{textAlign: 'center'}}>

![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/logout.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/showmodal.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/closemodal.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/setlocalstorage.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/copytoclipboard.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/generatefile.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/gotoapp1.png)
...
![Tele-CMS - How To - Run Actions from RunJS query](/img/how-to/run-actions-from-runjs/showalert.png)
