...
Currently, the datasources in Tele-CMS have operation for **bulk update(GUI mode)** but that only works for changes made in the single row. We will soon be adding a new operation for bulk updating the multiple rows but for now we can bulk update multiple rows by creating a Custom JS query.
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/postgres1.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/showData.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/columns.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/options.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/runjs1.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/update.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/event.png)
...
![Tele-CMS - How To - Bulk update multiple rows in table](/img/how-to/bulk-update-multiple/success.png)
