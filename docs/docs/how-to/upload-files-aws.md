...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/ui.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/getBuckets.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/dropdown.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/listObjects.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/table.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/download.png)
...
![Tele-CMS - How To - Upload files on AWS S3 bucket](/img/how-to/upload-files-aws/uploadToS3.png)
