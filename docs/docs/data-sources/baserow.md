...
Tele-CMS can connect to your Baserow account to read and write data. Baserow API token is required to create an Baserow data source on Tele-CMS. You can follow the steps to create API token from [this link](https://baserow.io/api-docs).
