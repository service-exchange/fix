...
![Tele-CMS - Kanban widget](/img/widgets/kanban/kanban.png)
...
Just like any other event on Tele-CMS, you can set multiple handlers for any of the above mentioned events.

<div style={{textAlign: 'center'}}>

![Tele-CMS - Kanban widget](/img/widgets/kanban/kanban-events.png)
...
![Tele-CMS - Kanban widget](/img/widgets/kanban/properties.png)
...
![Tele-CMS - Kanban widget](/img/widgets/kanban/layout.png)
...
![Tele-CMS - List view widget](/img/widgets/kanban/styles.png)
...
![Tele-CMS - List view widget](/img/widgets/kanban/variables.png)
