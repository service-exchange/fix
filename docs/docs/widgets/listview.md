...
![Tele-CMS - List view widget](/img/widgets/list-view/listviewapp.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/event.png)
...
**Row clicked** event is triggered when the button is clicked. Just like any other event on Tele-CMS, you can set multiple actions for a row clicked event.
...
![Tele-CMS - List view widget](/img/widgets/list-view/properties.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/listlayout.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/style.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/emptylist.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/data.gif)
...
![Tele-CMS - List view widget](/img/widgets/list-view/datadisplay.png)
...
![Tele-CMS - List view widget](/img/widgets/list-view/addingwidgets.gif)
