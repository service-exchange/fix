...
![Tele-CMS - Widget Reference - Timeline](/img/widgets/custom-component/custom-component.png)
...
Tele-CMS provides 3 props to interact with the app: `data`, `updateData` and `runQuery`.

- `data` is a shared object between custom component and Tele-CMS app.
...
const ConnectedComponent = TeleCMS.connectComponent(MyCustomComponent);

ReactDOM.render(<ConnectedComponent />, document.body);
```

:::info
`TeleCMS.connectComponent` acts as a HOC and it is required to get access to the data passed into the custom component and run the query
:::
