...
<iframe height="500"src="https://www.youtube.com/embed/zw3yxC7WUOg" title="Tele-CMS Button Widget" frameborder="0" allowfullscreen width="100%"></iframe>
...
![Tele-CMS - Widget Reference - Button Action List](/img/widgets/button/button-actions.png)
...
**On Click** event is triggered when the button is clicked. Just like any other event on Tele-CMS, you can set multiple handlers for on click event.
...
![Tele-CMS - widget- button](/img/widgets/button/properties.png)
...
![Tele-CMS - widget- button](/img/widgets/list-view/listlayout.png)
...
![Tele-CMS - widget- button](/img/widgets/button/styles.png)
