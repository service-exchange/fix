...
const API_URL = {
  production: process.env.TELECMS_SERVER_URL || (process.env.SERVE_CLIENT !== 'false' ? '__REPLACE_SUB_PATH__' : ''),
  development: `http://localhost:${process.env.TELECMS_SERVER_PORT || 3000}`,
};
