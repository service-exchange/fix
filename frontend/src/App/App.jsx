...
import { authenticationService, telecmsService } from '@/_services';
...
class App extends React.Component {
  ...
  fetchMetadata = () => {
    if (this.state.currentUser) {
      telecmsService.fetchMetaData().then((data) => {
          ...
          <div className={`main-wrapper ${darkMode ? 'theme-dark' : ''}`}>
            {updateAvailable && (
              <div className="alert alert-info alert-dismissible" role="alert">
                ...
                <p>A new version of Tele-CMS has been released.</p>
                <div className="btn-list">
                  <a
                    href="https://docs.service.exchange/docs/setup/updating"
                    target="_blank"
