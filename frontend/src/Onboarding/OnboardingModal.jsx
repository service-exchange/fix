...
import { telecmsService } from '@/_services';
...
class OnboardingModal extends React.Component {
  ...
  finishOnboarding = () => {
    ...
    telecmsService.finishOnboarding(this.state.options);
  };

  skipOnboard = () => {
    telecmsService.skipOnboarding();
  ...
  render() {
    return (
      ...
      >
        <Modal.Header>
          <Modal.Title className="text-center">Finish Tele-CMS installation</Modal.Title>
          <br />
        </Modal.Header>
        ...
        <Modal.Body>
          ...
          <small>You will receive updates from the Tele-CMS team ( 1-2 emails every month, we do not spam )</small>
        </Modal.Body>
