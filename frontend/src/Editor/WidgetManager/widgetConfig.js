export const widgets = [
  ...
  },
  {
    ...
    exposedVariables: {
      value:
        'Tele-CMS is an open-source low-code platform for building and deploying internal tools with minimal engineering efforts 🚀',
    },
    actions: [
      {
        handle: 'setText',
  ...
  },
  {
    ...
    definition: {
      ...
      properties: {
        source: { value: 'https://service.exchange/' },
        visible: { value: '{{true}}' },
      },
      events: [],
      styles: {
    ...
    defaultChildren: [
      {
        ...
        properties: ['source'],
        defaultValue: {
          source: 'https://s3.us-west-1.amazonaws.com/service.exchange/images/logo-svg/logo.svg',
        },
      },
      {
        componentName: 'Text',
        ...
        properties: ['text'],
        defaultValue: {
          text: 'Modern CMS for Healthcare Services to build & deploy internal tools within minutes.',
        },
      },
      {
        componentName: 'Table',
