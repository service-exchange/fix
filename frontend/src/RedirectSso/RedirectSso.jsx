        ...
        <div className=" py-2">
          ...
          <div className="sso-helper-container">
            ...
            <p className="sso-helper-doc">
              ...
              <a style={{ marginLeft: '4px' }} href="https://docs.service.exchange/docs/tutorial/multiworkspace">
                Multi-Workspace
              </a>
              ...
              <a
                ...
                href="https://docs.service.exchange/docs/category/single-sign-on"
              >
                Link
              </a>
              to configure SSO.
                ...
                <>
                  <div>
                    ...
                    <p>
                      ...
                      <a
                        href="https://docs.service.exchange/docs/user-authentication/general-settings"
                      ...
                      {googlessoEnabled && (
                        <>
                          <p className="sso-type">
                            <span className="">-</span>
                            Google : <a href="https://docs.service.exchange/docs/sso/google"> Link</a>
                          </p>
                          <div className="flexer">
                            <span> Redirect URL: </span>
                            <p id="google-url">{`${window.public_config?.TELECMS_HOST}/sso/google/${organization?.google?.config_id}`}</p>
                    ...
                    <div>
                      {gitSsoEnabled && (
                        <>
                          <p className="sso-type ">
                            <span className="">-</span>
                            GitHub : <a href="https://docs.service.exchange/docs/sso/github"> Link</a>
                          </p>

                          <div className="flexer">
                            <span> Redirect URL :</span>
                            <p id="git-url">{`${window.public_config?.TELECMS_HOST}/sso/git/${organization?.git?.config_id}`}</p>
