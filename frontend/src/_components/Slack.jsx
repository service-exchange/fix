      ...
      <div className="row">
        <div className="col-md-12">
          <div className="mb-3">
            ...
            <p>
              Tele-CMS can connect to Slack and list users, send messages, etc. Please select appropriate permission
              scopes.
            </p>
            <div>
              <label className="form-check mt-3">
                ...
                <span className="form-check-label">
                  ...
                  <small className="text-muted">
                    Your Tele-CMS app will be able to list users and send messages to users & channels.
                  </small>
                </span>
              </label>
            </div>
