...
export class EmailService {
  private FROM_EMAIL;
  private TELECMS_HOST;
  private NODE_ENV;

  constructor() {
    this.FROM_EMAIL = process.env.DEFAULT_FROM_EMAIL || 'hello@service.exchange';
    this.TELECMS_HOST = this.stripTrailingSlash(process.env.TELECMS_HOST);
  ...
  async sendWelcomeEmail(
    ...
    const subject = 'Welcome to Tele-CMS';
    const inviteUrl = `${this.TELECMS_HOST}/invitations/${invitationtoken}${
        ...
        <body>
          ...
          ${
            organizationInvitationToken && sender && organizationName
              ? `<span>
              ${sender} has invited you to use Tele-CMS workspace: ${organizationName}.
            </span>`
              : ''
          }
          <span>
  ...
  async sendOrganizationUserWelcomeEmail(
    ...
    const subject = 'Welcome to Tele-CMS';
    const inviteUrl = `${this.TELECMS_HOST}/organization-invitations/${invitationtoken}`;
    const html = `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          ...
          <br>
          <span>
          ${sender} has invited you to use Tele-CMS workspace: ${organizationName}. Use the link below to set up your account and get started.
          </span>
          <br>
          <a href="${inviteUrl}">${inviteUrl}</a>
          <br>
  ...
  async sendPasswordResetEmail(to: string, token: string) {
    ...
    const url = `${this.TELECMS_HOST}/reset-password/${token}`;
    const html = `
